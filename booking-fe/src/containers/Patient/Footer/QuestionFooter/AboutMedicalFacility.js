...
import './AboutMedicalFacility.scss';
import { LANGUAGES } from '../../../../utils';
import NumericFormat from 'react-number-format';
import HomeHeader from '../../../HomePage/HomeHeader';
import HomeFooter from '../../../HomePage/HomeFooter';

class AboutMedicalFacility extends Component {
    constructor(props) {
        super(props);
        this.state = {
...
export default connect(mapStateToProps, mapDispatchToProps)(AboutMedicalFacility);
