...
class ManageDoctor extends Component {
    ...
    componentDidUpdate(prevProps, prevState, snapshot) {
        ...
        if (prevProps.language !== this.props.language) { // func update thay đổi ngông ngữ
            let dataSelect = this.buildDataInputSelect(this.props.allDoctors, 'USERS');
    ...
    handleChangeSelectDoctorInfor = async (selectedOption, name) => {
        ...
        let stateCopy = { ...this.state };// copy state --> gán state =selectedOption
            ...
            <div className="manage-doctor-container">
                ...
                <div className="more-infor">
                    <div className="content-left form-group">
                        <label><FormattedMessage id="admin.manage-doctor.select-doctor" />
                ...
                <button className={hasOlData === true ? "save-content-doctor" : "create-content-doctor"}
                    ...
                    {hasOlData === true ? <span><FormattedMessage id="admin.manage-doctor.save" /> </span> :
